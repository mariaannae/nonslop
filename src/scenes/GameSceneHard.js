import { COLORS_HEX, COLORS_TEXT, OUTLINE_WIDTH, BUTTON_OUTLINE_WIDTH, CORNER_RADIUS, BUTTON_CORNER_RADIUS, buttonHeight, buttonSpacing, buttonWidth, PROGRESS_BAR} from "../config/design_hard.js";
...
export default class GameSceneHard extends Phaser.Scene {
    ...
    createFailsCounter() {
        ...
        const progressBarWidth = 240; // Doubled the width from 120 to 240
        ...
        this.failsCounter = progressContainer;
    ...
    updateProgressFill() {
        ...
        const progressBarWidth = this.progressBarWidth || 120;
    ...
    checkAndExplodeWord() {
        ...
        if (this.aiSuggestedWords.includes(lastWord)) {
            ...
            // Successfully entered a word - update progress bar
            this.wordCount++;
